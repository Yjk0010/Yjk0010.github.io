<template>
  <div class="festivalCountdown">
    <div class="title cor-tip" v-if="nowFestivalText">
      现在正在 <span class="cor-da">{{ nowFestivalText }}</span> 小长假中
    </div>
    <div class="title cor-tip">
      距离下一个小长假 <span class="cor-da">{{ festivalText }}</span> 还有
    </div>
...
import { getFestival } from "/api/mxnzp.ts";
import { diffDate } from "/utils/index.ts";
